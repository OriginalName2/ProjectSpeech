...
(function(a, k) {
    ...
    if (v("native-xhr") && !v("dojo-force-activex-xhr")) P = function() {
    ...
    var E = {},
        ...
        ca = function(b) {
            var d, a, l, p;
            for (d in aa) a = aa[d], (l = d.match(/^url\:(.+)/)) ? M["url:" + Na(l[1], b)] = a : "*now" == d ? p = a : "*noref" != d && (l = la(d, b, !0), M[l.mid] = M["url:" + l.url] = a);
            p && p(Ca(b));
            aa = {}
        },
        Oa = function(b) {
        ...
        ma = function(d, a, p) {
            ...
            d.cache && (ca(), aa = d.cache, d.cache["*noref"] && ca());
            A("config", [d, q.rawConfig])
        };
    v("dojo-cdn");
    var ta = t.getElementsByTagName("script");
    h = 0;
    for (var Z, fa, ua, na; h < ta.length;)
        if (Z = ta[h++], (ua = Z.getAttribute("src")) && (na = ua.match(/(((.*)\/)|^)dojo\.js(\W|$)/i)) && (fa = na[3] || "", k.baseUrl = k.baseUrl || fa, ba = Z), ua = Z.getAttribute("data-dojo-config") || Z.getAttribute("djConfig")) W = q.eval("({ " + ua + " })", "data-dojo-config"), ba = Z;
    q.rawConfig = {};
    ma(k,
        1);
    ...
    var oa = function(d) {
        ...
        Ma = function(b, d, a, c, e) {
            ...
            if (m(b))
                if (b.length) {
                    a = "require*" + y();
                    for (var h, r = [], N = 0; N < b.length;) h = b[N++], r.push(Y(h, c));
                    f = l(va("", a, 0, ""), {
                        injected: 2,
                        deps: r,
                        def: d || n,
        ...
        Ca = function(b) {
            ...
            d || (d = function(a, l, p) {
                ...
                var a = G[d.mid];
                if (!a || !a.executed)
                    if (da = M[d.mid] || M["url:" + d.url]) wa(da), a = G[d.mid];
        ...
        Ta = function(d, a, l, c, e, g, m, h, y) {
            ...
            a && (q = Fa(a.mid, g));
            (q = (q = q || g.star) && Fa(d, q[1])) && (d = q[1] + d.substring(q[3]));
            a = (na = d.match(/^([^\/]+)(\/(.+))?$/)) ? na[1] : "";
            ...
            b(h, function(b) {
                var a = d.match(b[0]);
                a && 0 < a.length && (n =
                    f(b[1]) ? d.replace(b[0], b[1]) : b[1])
            });
            if (n) return Ta(n, 0, l, c, e, g, m, h, y);
            if (l = c[d]) return y ? va(l.pid, l.mid, l.pack, l.url) : c[d];
            c = (q = Fa(d, m)) ? q[1] + d.substring(q[3]) : a ? r.location + "/" + N : v("config-tlmSiblingOfDojo") ? "../" + d : d;
            /(^\/)|(\:)/.test(c) || (c = e + c);
            return va(a, d, r, Sa(c + ".js"))
        },
        la = function(b, d, a) {
            return Ta(b, d, B, G, q.baseUrl, a ? [] : F, a ? [] : K, a ? [] : H)
        },
        Ua = function(b, d, a) {
        ...
        Y = function(b, d, a) {
            var l, p;
            (l = b.match(/^(.+?)\!(.*)$/)) ? (p =
                Y(l[1], d, a), "sync" != w || p.executed || (ra(p), 2 !== p.injected || p.executed || ka(function() {
                    ja(p)
                }), p.executed ? za(p) : T.unshift(p)), 5 !== p.executed || p.load || za(p), p.load ? (l = Ua(p, l[2], d), b = p.mid + "!" + (p.dynamic ? ++Va + "!" : "") + l) : (l = l[2], b = p.mid + "!" + ++Va + "!waitingForPlugin"), b = {
                    plugin: p,
                    mid: b,
                    req: Ca(d),
                    prid: l
        ...
        ia = function(d) {
            ...
            d.loadQ && (za(d), gb(d));
            for (h = 0; h < T.length;) T[h] === d ? T.splice(h, 1) : h++;
        ...
        ha = function() {
            pa || ka(function() {
                X();
                for (var b, d, a = 0; a < T.length;) b = Ha, d = T[a], ja(d), b != Ha ? (X(), a = 0) : a++
            })
        };
    ...
    var sa = "function" == typeof a.fixupUrl ? a.fixupUrl : function(b) {
        ...
        wa = function(b, d) {
            ...
            Ia = 1;
            if (v("config-dojo-loader-catches")) try {
                b === da ? da.call(null) : q.eval(b, v("dojo-loader-eval-hint-url") ? d.url : d.mid)
            } catch (a) {
                A("error", p("evalModuleThrew", d))
            } else b === da ? da.call(null) : q.eval(b, v("dojo-loader-eval-hint-url") ? d.url : d.mid);
            Ia = 0
        },
        ra = function(d) {
            var a = d.mid,
            ...
            if (!(d.executed || d.injected || U[a] || d.url && (d.pack && U[d.url] === d.pack || 1 == U[d.url])))
                if (bb(d), d.plugin) Xa(d);
                    ...
                    if (da = M[a] || M["url:" + d.url]) q.trace("loader-inject", ["cache", d.mid, c]), wa(da, d), e();
                    else {
                        if (w)
                            ...
                            var g = function(l) {
                                if ("sync" == w) {
                                    ...
                                    e()
                                } else(l = R(d, l)) ? (wa(l, d), e()) : (qa = d, q.injectUrl(sa(c), e, d), qa = 0)
                            };
    ...
    for (h = 0; !ba;) /^dojo/.test((Z = ta[h++]) && Z.type) || (ba = Z);
    ...
    var Ja = function(b, d, a) {
        ...
        if ((l = e[0] && Y(e[0])) && !U[l.mid]) oa(Ka(l, e[1], e[2]));
            ...
            if (!l)
                for (b in U)
                    if ((c =
                            G[b]) && c.node && "interactive" === c.node.readyState) {
                        l = c;
                        break
                    }
            l ? (ca(l), oa(Ka(l, e[1], e[2]))) : A("error", p("ieDefineFailed", e[0]));
            ha()
        }
    };
    Ja.amd = {
            ...
            define(["./kernel", "../has", "./lang"], function(a, k, h) {
                ...
                function x(a, f, k) {
                    ...
                    if ("[object Array]" == z.call(f)) {
                        ...
                        J = {};
                        E = 1;
                        for (var ea = f.length, K = 0, B, L, F, G; K < ea; ++K) {
                            (B = f[K]) ? "[object Function]" != z.call(B) && n("mixin #" + K + " is not a callable constructor.", C): n("mixin #" + K + " is unknown. Did you use dojo.require to pull it in?", C);
                            L = B._meta ?
                                B._meta.bases : [B];
                            F = 0;
                            for (B = L.length - 1; 0 <= B; --B) G = L[B].prototype, G.hasOwnProperty("declaredClass") || (G.declaredClass = "uniqName_" + D++), G = G.declaredClass, J.hasOwnProperty(G) || (J[G] = {
                                count: 0,
                                refs: [],
                                cls: L[B]
                            }, ++E), G = J[G], F && F !== G && (G.refs.push(F), ++F.count), F = G;
                            ++F.count;
                            I[0].refs.push(F)
                        }
                        for (; I.length;) {
                            ...
                            if (F)
                                for (K = 0, ea = t.length; K < ea; ++K) F = t[K], --F.count || I.push(F)
                        }
                        E && n("can't build consistent linearization",
                            C);
                        B = f[0];
                        ...
                        C = E.length - I;
                        f = E[C]
                    } else E = [0], f ? "[object Function]" == z.call(f) ? (I = f._meta, E = E.concat(I ? I.bases : f)) : n("base class is not a callable constructor.", a) : null !== f && n("unknown base class. Did you use dojo.require to pull it in?", a);
                    if (f)
                        for (w = C - 1;; --w) {
                            t = r(f);
                            if (!w) break;
                    ...
                    for (w = C - 1; w; --w)(I = E[w]._meta) && I.chains && (A = v(A || {}, I.chains));
                    t["-chains-"] && (A = v(A || {}, t["-chains-"]));
                    I = !A || !A.hasOwnProperty("constructor");
                    E[0] = J = A && "manual" === A.constructor ? y(E) : 1 == E.length ? d(k.constructor, I) : p(E, I);
                    J._meta = {
                        bases: E,
                        hidden: k,
                        chains: A,
                    ...
                    a && (t.declaredClass =
                        a, h.setObject(a, J));
                    if (A)
                        for (Q in A) t[Q] && "string" == typeof A[Q] && "constructor" != Q && (I = t[Q] = q(Q, E, "after" === A[Q]), I.nom = Q);
                    return J
                }
                var v = h.mixin,
                    u = Object.prototype,
        ...
        "dojo/on": function() {
            define(["./has!dom-addeventlistener?:./aspect", "./_base/kernel", "./sniff"], function(a, k, h) {
                function n(b, d, a, c, e) {
                    ...
                    h("touch") && (m.test(d) && (a = D(a)), h("event-orientationchange") || "orientationchange" != d || (d = "resize", b = window, a = D(a)));
                    y && (a = y(a));
                    ...
                    function a(a, c, b, e) {
                        ...
                        if (d) {
                            ...
                            h = {
                                ...
                                advice: function(b, d) {
                                    return q ? q.apply(b, d) : f.advice(b, d)
                                }
                            }
                        } else h = {
                            remove: function() {
                ...
                function(a, k, h, n, c) {
                    var e = n.trim,
                        ...
                        l = function(a) {
                            ...
                            for (var b = function(b, c) {
                                ...
                                }, c = [], d = -1, f = -1, g = -1, h = -1, l = -1, k = -1, n = -1, p, t = "", v = "", D, q = 0, N = a.length, r = null, u = null, x = function() {
                                    0 <= k && (r.id = b(k, q).replace(/\\/g, ""), k = -1);
                                    if (0 <= n) {
                                        var a = n == q ? null : b(n, q);
                                        r[0 > "\x3e~+".indexOf(a) ? "tag" : "oper"] = a;
                                        n = -1
                                    }
                                    0 <= l && (r.classes.push(b(l + 1, q).replace(/\\/g, "")), l = -1)
                                }; t = v, v = a.charAt(q),
                                q < N; q++) "\\" != t && (r || (D = q, r = {
                                    query: null,
                                    pseudos: [],
                                ...
                                }, n = q), p ? v == p && (p = null) : "'" == v || '"' == v ? p = v : 0 <= d ? "]" == v ? (u.attr ? u.matchFor = b(g || d + 1, q) : u.attr = b(d + 1, q), !(d = u.matchFor) || '"' != d.charAt(0) && "'" != d.charAt(0) || (u.matchFor = d.slice(1, -1)), u.matchFor && (u.matchFor = u.matchFor.replace(/\\/g, "")), r.attrs.push(u), u = null, d = g = -1) : "\x3d" == v && (g = 0 <= "|~^$*".indexOf(t) ? t : "", u.type = g + v, u.attr = b(d + 1, q - g.length), g = q + 1) : 0 <= f ? ")" ==
                                v && (0 <= h && (u.value = b(f + 1, q)), h = f = -1) : "#" == v ? (x(), k = q + 1) : "." == v ? (x(), l = q) : ":" == v ? (x(), h = q) : "[" == v ? (x(), d = q, u = {}) : "(" == v ? (0 <= h && (u = {
                                    name: b(h + 1, q),
                                    value: null
                                }, r.pseudos.push(u)), f = q) : " " == v && t != v && (x(), 0 <= h && r.pseudos.push({
                                    name: b(h + 1, q)
                                }), r.loops = r.pseudos.length || r.attrs.length || r.classes.length, r.oquery = r.query = b(D, q), r.otag = r.tag = r.oper ? null : r.tag || "*", r.tag && (r.tag = r.tag.toUpperCase()), c.length && c[c.length - 1].oper && (r.infixOper = c.pop(), r.query = r.infixOper.query + " " + r.query), c.push(r), r = null));
                            return c
                        },
                        p = function(a, b) {
                            return a ? b ? function() {
                        ...
                        E = function(e) {
                            ...
                            if (h) m = {
                                el: 1
                            }, k && (m.tag = 1), l = O(e, m), "+" == h ? f = S(l) : "~" == h ? f = I(l) : "\x3e" == h && (f = J(l));
                            else if (e.id) l = !e.loops && k ? b : O(e, {
                                el: 1,
                                id: 1
                            }), f = function(b, c) {
                            ...
                            else if (m && /\{\s*\[native code\]\s*\}/.test(String(m)) && e.classes.length && !g) var l = O(e, {
                                    el: 1,
                                    classes: 1,
                                    id: 1
                                }),
                                ...
                                f = function(a, b, c) {
                                    b = d(0, b);
                                    for (var e, f = 0, g = a.getElementsByClassName(n); e = g[f++];) l(e, a) && W(e, c) && b.push(e);
                                    return b
                                };
                            else k || e.loops ? (l = O(e, {
                                el: 1,
                                tag: 1,
                                id: 1
                            }), f = function(a, b, c) {
                                b = d(0, b);
                                for (var f, g = 0, h = (f = e.getTag()) ? a.getElementsByTagName(f) : []; f = h[g++];) l(f, a) && W(f, c) && b.push(f);
                                return b
                            }) : f = function(a, b, c) {
                                b = d(0, b);
                        ...
                        V = function(a, b) {
                            ...
                            if (!K || b || -1 != "\x3e~+".indexOf(c) || k("ie") && -1 != a.indexOf(":") || g && 0 <= a.indexOf(".") || -1 != a.indexOf(":contains") || -1 != a.indexOf(":checked") || -1 != a.indexOf("|\x3d")) {
                                ...
                                return A[a] = 2 > e.length ? H(a) : function(a) {
                                    for (var b = 0, c = [], d; d = e[b++];) c = c.concat(H(d)(a));
                                    return c
                                }
                            }
                    ...
                    ca.filter = function(b, c, d) {
                        for (var e = [], f = l(c), f = 1 != f.length || /[^\w#\.]/.test(c) ? function(b) {
                                return -1 !=
                                    h.indexOf(ca(c, a.byId(d)), b)
                            } : O(f[0]), g = 0, k; k = b[g]; g++) f(k) && e.push(k);
                        return e
                    };
                    return ca
                })
                        ...
                        if (1 == c.nodeType || "only" != d)
                            for (var g, h = b.length, l = h - 1; 0 <= l; l--) {
                                ...
                                if (b._runParse && a.parser && a.parser.parse)
                                    for (g || (g = c.ownerDocument.createElement("div")), g.appendChild(k), a.parser.parse(g), k = g.firstChild; g.firstChild;) g.removeChild(g.firstChild);
        ...
        "dojo/_base/xhr": function() {
            define("./kernel ./sniff require ../io-query ../dom ../dom-form ./Deferred ./config ./json ./lang ./array ../on ../aspect ../request/watch ../request/xhr ../request/util".split(" "), function(a, k, h, n, c, e, f,
                ...
                a._ioSetArgs = function(d, g, h, l) {
                    ...
                    k.query = n.objectToQuery(b.mixin.apply(null, p));
                    ...
                    q.addCallback(h);
                    var r = d.load;
                    r && b.isFunction(r) && q.addCallback(function(a) {
                        return r.call(d, a, k)
                    });
                    var v = d.error;
                    v && b.isFunction(v) && q.addErrback(function(a) {
                        return v.call(d, a, k)
                    });
                    var u = d.handle;
                    u && b.isFunction(u) && q.addBoth(function(a) {
                        return u.call(d, a, k)
                    });
                    q.addErrback(function(a) {
                        return l(a, q)
                    });
                    t.ioPublish && a.publish && !1 !== k.args.ioPublish && (q.addCallbacks(function(b) {
                        a.publish("/dojo/io/load", [q, b]);
                        return b
                    }, function(b) {
                        a.publish("/dojo/io/error", [q, b]);
                        return b
                    }), q.addBoth(function(b) {
                        a.publish("/dojo/io/done", [q, b]);
                        return b
                    }));
                    q.ioArgs = k;
                    return q
            ...
            define(["../errors/RequestError", "./watch", "./handlers", "./util", "../has"], function(a, k, h, n, c) {
                ...
                function g(h, t, x) {
                    ...
                    var z, w = n.deferred(u, d, b, l,
                        ...
                        D = u.xhr = g._create();
                    if (!D) return w.cancel(new a("XHR was not created")), x ? w : w.promise;
                    u.getHeader = f;
                    p && (z = p(D, w, u));
                    var N = t.data,
                        X = !t.sync,
                        R = t.method;
                    try {
                        D.open(R, h, X, t.user || y, t.password || y);
                        ...
                        if (P)
                            for (var O in P) "content-type" === O.toLowerCase() ? h = P[O] : P[O] && D.setRequestHeader(O, P[O]);
                        h &&
                            !1 !== h && D.setRequestHeader("Content-Type", h);
            ...
            define("./kernel ../has require module ../json ./lang ./array".split(" "), function(a, k, h, n, c, e, f) {
                var g = function(a) {
                    ...
                    d = function() {
                        var a, c;
                        for (c in P)
                            if (a = P[c], void 0 === a.noReqPluginCheck && (a.noReqPluginCheck = /loadInit\!/.test(c) || /require\!/.test(c) ? 1 : 0), !a.executed && !a.noReqPluginCheck && a.injected == z) return;
                        H(function() {
                            var a = b;
                            b = [];
                    ...
                    v = h.initSyncLoader(p, d, function(a, b) {
                        ...
                        e = a.mid + "-*loadInit";
                        for (var h in S("dojo", a).result.scopeMap) f.push(h), g.push('"' + h + '"');
                ...
                a.require = function(a, b) {
                    var c = function(a, b) {
                        var c = S(g(a), h.module);
                        if (R.length && R[0].finish) R[0].finish.push(a);
                        else {
                ...
                var z = {},
                    w = {
                        ...
                        construct: function(a,
                            ...
                            function r(a) {
                                z && h.setObject(z, a);
                                for (C = 0; C < F.length; C++) m[F[C].advice || "after"](a, F[C].method, h.hitch(a, F[C].func), !0);
                                for (C = 0; C < G.length; C++) G[C].call(a);
                                for (C = 0; C < V.length; C++) a.watch(V[C].prop, V[C].func);
                                for (C = 0; C < M.length; C++) q(a, M[C].event, M[C].func);
                                return a
                            }
                            var v = a && a.prototype;
                            e = e || {};
                            ...
                            p = "data-" + E + "-";
                            var A = {};
                            "dojo" !== E && (A[p + "props"] = "data-dojo-props", A[p + "type"] = "data-dojo-type", A[p + "mixins"] = "data-dojo-mixins", A[E + "type"] =
                                    ...
                                    default:
                                        if (B in v || (B = x(a)[L] || B), B in v) switch (typeof v[B]) {
                                            ...
                                            case "boolean":
                                                ...
                                                break;
                                            case "function":
                                                "" === H || -1 != H.search(/[^\w\.]+/i) ? u[B] = new Function(H) : u[B] = h.getObject(H, !1) || new Function(H);
                                                E.push(B);
                                                break;
                                            default:
                                                L = v[B], u[B] = L && "length" in L ? H ? H.split(/\s*,\s*/) : [] : L instanceof Date ? "" == H ? new Date("") : "now" == H ? new Date : l.fromISOString(H) : L instanceof g ? k.baseUrl + H : t(H)
                                        } else u[B] =
                                            H
                                }
                            }
                            for (w = 0; w < E.length; w++) A = E[w].toLowerCase(), b.removeAttribute(A), b[A] = null;
                            if (K) try {
                            ...
                            var F = [],
                                ...
                                M = [];
                            if (f)
                                for (C = 0; C < f.length; C++) A = f[C], b.removeChild(A), c = A.getAttribute(p + "event") || A.getAttribute("event"), e = A.getAttribute(p + "prop"), K = A.getAttribute(p + "method"), E = A.getAttribute(p + "advice"),
                                    w = A.getAttribute("type"), A = this._functionFromScript(A, p), c ? "dojo/connect" == w ? F.push({
                                        method: c,
                                        func: A
                                    }) : "dojo/on" == w ? M.push({
                                        event: c,
                        ...
                        scan: function(b, c) {
                            ...
                            for (var u = {
                                ...
                                if (r)
                                    ...
                                    else if (y && "script" == r.nodeName.toLowerCase())(B = r.getAttribute("type")) && /^dojo\/\w/i.test(B) && y.push(r), r = r.nextSibling;
        ...
        "dojo/request/script": function() {
            define("module ./watch ./util ../_base/kernel ../_base/array ../_base/lang ../on ../dom ../dom-construct ../has ../_base/window".split(" "), function(a, k, h, n, c, e, f, g, m, b, l) {
                ...
                function t(a, b,
                    ...
                    b.jsonp && ((new RegExp("[?\x26]" + b.jsonp + "\x3d")).test(a) || (a += (~a.indexOf("?") ? "\x26" : "?") + b.jsonp + "\x3d" + (b.frameDoc ? "parent." : "") + x + "_callbacks." + l.id), l.canDelete = !0, w[l.id] = function(a) {
                        g.data = a;
                        l.handleResponse(g)
                    });
                    ...
                    if (!b.canAttach || b.canAttach(l)) {
                        ...
                        if (!b.jsonp &&
                            !b.checkString) var n = f(m, u, function(a) {
                            if ("load" === a.type || z.test(m.readyState)) n.remove(), l.scriptLoaded = a
                        })
                    }
                    k(l);
