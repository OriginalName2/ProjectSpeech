...
require({
    cache: {
            ...
            define(["dojo/_base/array", "dojo/_base/window", "./main"], function(m, l, g) {
                var h = {},
                    ...
                    b = {
                        length: 0,
                        add: function(b) {
                            if (c[b.id]) throw Error("Tried to register widget with id\x3d\x3d" +
                                b.id + " but that id is already registered");
                            c[b.id] = b;
                            this.length++
                        },
                        remove: function(b) {
                            c[b] && (delete c[b], this.length--)
                        },
                        byId: function(b) {
                        ...
                        getUniqueId: function(b) {
                            var f;
                            do f = b + "_" + (b in h ? ++h[b] : h[b] = 0); while (c[f]);
                            return "dijit" == g._scopeName ? f : g._scopeName + "_" + f
                        },
            ...
            define("dojo/_base/declare dijit/_WidgetBase dijit/_TemplatedMixin dojo/text!./templates/modal.html ./SignupFormFrame ./BannerFrame dojo/query dojo/_base/lang dojo/on dojo/dom-construct dojo/dom-style dojo/sniff dojo/keys dojo/promise/all dojo/Deferred dojo/dom-class mojo/widgets/_CustomStyleRulesMixin dojo/NodeList-manipulate".split(" "), function(m, l, g, h, c, b, k, f, a, d, e, z, n, t, y, r, w) {
                return m("PopupSignupForm", [l, g, w], {
                    ...
                    postMixInProperties: function() {
                        ...
                        this.config.closeLabel && (this.closeLabel =
                    ...
                    startup: function() {
                        ...
                        this._hasCookie() || (this.bannerFrame = new b({
                                ...
                                config: this.config
                            }), this.bannerFrame.startup(), this.modalFrame =
                            new c({
                                ...
                                env: this.env
                            }), this.modalFrame.startup(), this._setupModal(), t([this.loadModalCss(), this.loadCustomCss()]).then(f.hitch(this, "openModal")))
                    },
                    openModal: function() {
                        function a() {
                            e();
                        ...
                        function b() {
                            window.innerHeight + window.scrollY >= document.body.offsetHeight / 2 && (e(), document.removeEventListener("scroll", b, !1))
                        }

                        function d() {
                            window.innerHeight +
                                window.scrollY >= document.body.offsetHeight && (e(), document.removeEventListener("scroll", d, !1))
                        }
                    ...
                    _closeModal: function() {
                        ...
                        if (void 0 === this.modalContainer.style.animation || "fixed" !== this.config.modalVariation && "slide" !== this.config.modalVariation) this._hideOverlay();
                        else try {
                            this.modalContainer.addEventListener("webkitAnimationEnd", this._hideOverlay.bind(this)), this.modalContainer.addEventListener("animationend", this._hideOverlay.bind(this)),
                    ...
                    loadModalCss: function() {
                        ...
                        d.rel = "stylesheet";
                        d.type = "text/css";
                        "dev" == this.env ? (d.href = "/css/signup-forms/popup/modal.css", "slide" ===
                            this.config.modalVariation ? d.href = "/css/signup-forms/popup/modal-slidein.css" : "fixed" === this.config.modalVariation && (d.href = "/css/signup-forms/popup/modal-fixed.css")) : (d.href = "//downloads.mailchimp.com/css/signup-forms/popup/" + this.version + "/modal.css", "slide" === this.config.modalVariation ? d.href = "//downloads.mailchimp.com/css/signup-forms/popup/" + this.version + "/modal-slidein.css" : "fixed" === this.config.modalVariation && (d.href = "//downloads.mailchimp.com/css/signup-forms/popup/" + this.version + "/modal-fixed.css"));
                        d.media = "all";
                        a(d, "load", function() {
                            b.resolve()
                        });
                        ...
                        if (this.styles)
                            for (var e in this.styles)
                                if (this.styles.hasOwnProperty(e)) switch (e) {
                                    case "modal":
                                        for (var c in this.styles[e]) switch (c) {
                                            case "close_link_color":
                                                this.addCSSRule(b, ".mc-closeModal", "color:" +
                                                    this.styles[e][c] + ";")
                                        }
            ...
            define("require dojo/_base/array dojo/aspect dojo/_base/config dojo/_base/connect dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/dom-geometry dojo/dom-style dojo/has dojo/_base/kernel dojo/_base/lang dojo/on dojo/ready dojo/Stateful dojo/topic dojo/_base/window ./Destroyable dojo/has!dojo-bidi?./_BidiMixin ./registry".split(" "), function(m, l, g, h, c, b, k, f, a, d, e, z, n, t, y, r, w, x, v, q, u, A, p) {
                ...
                h = b("dijit._WidgetBase", [x, u], {
                    ...
                    _introspect: function() {
                        ...
                        if (!a._setterAttrs) {
                            var d = a.prototype,
                                ...
                                a = a._onMap = {},
                                e;
                            for (e in d.attributeMap) b.push(e);
                            for (e in d) /^on/.test(e) && (a[e.substring(2).toLowerCase()] = e), /^_set[A-Z](.*)Attr$/.test(e) && (e = e.charAt(4).toLowerCase() + e.substr(5, e.length - 9), d.attributeMap && e in d.attributeMap || b.push(e))
                        }
                    },
                    ...
                    create: function(a, d) {
                        ...
                        a && (this.params = a, y.mixin(this, a));
                        ...
                        if (this.domNode) {
                            ...
                            e && e.parentNode && this.domNode !== e && (e.parentNode.replaceChild(this.domNode, e), b = !0);
                    ...
                    _applyAttributes: function() {
                        var a = {},
                            d;
                        for (d in this.params || {}) a[d] = this._get(d);
                    ...
                    startup: function() {
                        this._started || (this._started = !0, l.forEach(this.getChildren(), function(a) {
                            a._started || a._destroyed || !y.isFunction(a.startup) || (a.startup(), a._started = !0)
                        }))
                    },
                    ...
                    destroyRendering: function(a) {
                        ...
                        this.domNode && (a ? f.remove(this.domNode, "widgetId") : d.destroy(this.domNode), delete this.domNode);
                        this.srcNodeRef && (a || d.destroy(this.srcNodeRef), delete this.srcNodeRef)
                    },
                    ...
                    _attrToDom: function(d, b, e) {
                        e = 3 <=
                            arguments.length ? e : this.attributeMap[d];
                    ...
                    set: function(a, d) {
                        ...
                        var e = this[b.s];
                        if (y.isFunction(e)) var c = e.apply(this, Array.prototype.slice.call(arguments, 1));
                        else {
                            var e = this.focusNode && !y.isFunction(this.focusNode) ? "focusNode" : "domNode",
                                n = this[e] && this[e].tagName,
                                z;
                            if ((z = n) && !(z = L[n])) {
                                z = this[e];
                                var p = {},
                                    f;
                                for (f in z) p[f.toLowerCase()] = !0;
                                z = L[n] = p
                            }
                            f = z;
                            b = a in this.attributeMap ? this.attributeMap[a] :
                                b.s in this ? this[b.s] : f && b.l in f && "function" != typeof d || /^aria-|^data-|^role$/.test(a) ? e : null;
                    ...
                    _set: function(a, d) {
                        var b = this[a];
                        this[a] = d;
                        !this._created || b === d || b !== b && d !== d || (this._watchCallbacks &&
                            this._watchCallbacks(a, b, d), this.emit("attrmodified-" + a, {
                                detail: {
                                    prevValue: b,
                                    newValue: d
                                }
                    ...
                    on: function(a, d) {
                        var b = this._onMap(a);
                        return b ? g.after(this, b, d, !0) : this.own(r(this.domNode,
                            a, d))[0]
                    },
                    _onMap: function(a) {
                        ...
                        if (!b) {
                            var b = d._onMap = {},
                                e;
                            for (e in d.prototype) /^on/.test(e) && (b[e.replace(/^on/, "").toLowerCase()] = e)
                        }
                    ...
                    placeAt: function(a, b) {
                        ...
                        !e || !e.addChild || b && "number" !== typeof b ? (e = e && "domNode" in e ? e.containerNode && !/after|before|replace/.test(b ||
                            "") ? e.containerNode : e.domNode : k.byId(a, this.ownerDocument), d.place(this.domNode, e, b), !this._started && (this.getParent() || {})._started && this.startup()) : e.addChild(this, b);
                        return this
                    },
                    defer: function(a, d) {
                        var b = setTimeout(y.hitch(this, function() {
                            b && (b = null, this._destroyed || y.hitch(this, a)())
                        }), d || 0);
                        return {
                            remove: function() {
        ...
        "dojo/Stateful": function() {
            define(["./_base/declare", "./_base/lang", "./_base/array", "./when"],
                function(m, l, g, h) {
                    return m("dojo.Stateful", null, {
                        ...
                        set: function(c, b) {
                            if ("object" === typeof c) {
                                for (var k in c) c.hasOwnProperty(k) && "_watchCallbacks" != k && this.set(k, c[k]);
                                return this
                            }
                            ...
                            if (!k) var f = this,
                                k = this._watchCallbacks = function(a, d, b, c) {
                                    var g = function(c) {
                                        if (c) {
                                            c = c.slice();
                                            for (var k = 0, g = c.length; k <
                                                g; k++) c[k].call(f, a, d, b)
                                        }
                                    };
                                    g(k["_" + a]);
                                    c || g(k["*"])
                                };
                            b || "function" !== typeof c ? c = "_" + c : (b = c, c = "*");
                            var a = k[c];
                            "object" !== typeof a && (a = k[c] = []);
                            a.push(b);
                            var d = {};
                            d.unwatch = d.remove = function() {
                                var d = g.indexOf(a, b); - 1 < d && a.splice(d, 1)
                            };
                            return d
                        }
                    })
                        ...
                        m.forEach(arguments,
                            function(c) {
                                ...
                                var k, f = l.before(this, "destroy", function(a) {
                                    ...
                                    a = [];
                                c.then ? (k = "cancel", c.then(b, b)) : m.forEach(g, function(d) {
                                    "function" === typeof c[d] && (k || (k = d), a.push(l.after(c, d, b, !0)))
                                })
                            }, this);
                        return arguments
                    }
        ...
        "dijit/_TemplatedMixin": function() {
            define("dojo/cache dojo/_base/declare dojo/dom-construct dojo/_base/lang dojo/on dojo/sniff dojo/string ./_AttachMixin".split(" "), function(m, l, g, h, c, b, k, f) {
                    ...
                    f, {
                        ...
                        buildRendering: function() {
                            if (!this._rendered) {
                                ...
                                var d = a.getCachedTemplate(this.templateString, this._skipNodeCache, this.ownerDocument),
                                    b;
                                if (h.isString(d)) {
                                    if (b = g.toDom(this._stringRepl(d), this.ownerDocument), 1 != b.nodeType) throw Error("Invalid template: " + d);
                                } else b = d.cloneNode(!0);
                                this.domNode = b
                            }
                            this.inherited(arguments);
                ...
                a.getCachedTemplate = function(d, b, c) {
                    ...
                    if (h) {
                        try {
                            if (!h.ownerDocument || h.ownerDocument == (c || document)) return h
                        } catch (l) {}
                        g.destroy(h)
                    }
                    d = k.trim(d);
                    if (b || d.match(/\$\{([^\}]+)\}/g)) return n[f] = d;
                    b = g.toDom(d, c);
                    if (1 != b.nodeType) throw Error("Invalid template: " + d);
                    return n[f] = b
                };
                b("ie") && c(window, "unload", function() {
                    var d = a._templateCache,
                        b;
                    for (b in d) {
                        var c = d[b];
        ...
        "dojo/text": function() {
            define(["./_base/kernel", "require", "./has", "./request"], function(m, l, g, h) {
                ...
                m.cache =
                    function(a, e, f) {
                        var n;
                        "string" == typeof a ? /\//.test(a) ? (n = a, f = e) : n = l.toUrl(a.replace(/\./g, "/") + (e ? "/" + e : "")) : (n = a + "", f = e);
                        a = void 0 != f && "string" != typeof f ? f.value : f;
                        f = f && f.sanitize;
                        if ("string" == typeof a) return b[n] = a, f ? k(a) : a;
            ...
            define("require dojo/_base/array dojo/_base/connect dojo/_base/declare dojo/_base/lang dojo/mouse dojo/on dojo/touch ./_WidgetBase".split(" "), function(m, l, g, h, c, b, k, f, a) {
                ...
                g = h("dijit._AttachMixin", null, {
                    ...
                    _processTemplateNode: function(a, b, d) {
                        ...
                        if (g)
                            for (var h = g.split(/\s*,\s*/); g =
                                h.shift();) c.isArray(f[g]) ? f[g].push(a) : f[g] = a, e = "containerNode" != g, this._attachPoints.push(g);
                        if (b = b(a, "dojoAttachEvent") || b(a, "data-dojo-attach-event"))
                            for (g = b.split(/\s*,\s*/), h = c.trim; b = g.shift();)
                                if (b) {
                                    var l = null; - 1 != b.indexOf(":") ? (l = b.split(":"), b = h(l[0]), l = h(l[1])) : b = h(b);
                                    l || (l = b);
        ...
        "dojo/touch": function() {
            define("./_base/kernel ./aspect ./dom ./dom-class ./_base/lang ./on ./has ./mouse ./domReady ./_base/window".split(" "), function(m, l, g, h, c, b, k, f, a, d) {
                ...
                function n(a, e, c) {
                    if (!f.isRight(a)) {
                        ...
                        if (v = !a.target.disabled && n && n.dojoClick)
                            if (u = (q = "useTarget" == v) ? n : a.target, q && a.preventDefault(),
                                A = a.changedTouches ? a.changedTouches[0].pageX - d.global.pageXOffset : a.clientX, p = a.changedTouches ? a.changedTouches[0].pageY - d.global.pageYOffset : a.clientY, J = ("object" == typeof v ? v.x : "number" == typeof v ? v : 0) || 4, L = ("object" == typeof v ? v.y : "number" == typeof v ? v : 0) || 4, !x) {
                                a = function(a) {
                                    d.doc.addEventListener(a, function(b) {
                                        var d = b.target;
                                        if (v && !b._dojo_click && (new Date).getTime() <= M + 1E3 && ("INPUT" != d.tagName || !h.contains(d, "dijitOffScreen")) && (b.stopPropagation(), b.stopImmediatePropagation && b.stopImmediatePropagation(),
                                            ...
                                            try {
                                                if ("A" == d.tagName) {
                                                    for (;
                                                        (d = d.parentElement) && !d.classList.contains("dijitMenu") && !d.classList.contains("dijitButtonNode"););
                                                    e = d
                                                }
                                            } catch (c) {}
                                            e || b.preventDefault()
                                ...
                                var l = function(a) {
                                    v = q ? g.isDescendant(d.doc.elementFromPoint(a.changedTouches ?
                                ...
                                d.doc.addEventListener(e, function(a) {
                                    f.isRight(a) || (l(a), q && a.preventDefault())
                                }, !0);
                ...
                var t = 5 > k("ios"),
                    y = k("pointer-events") || k("MSPointer"),
                    r = function() {
                        var a = {},
                            b;
                        for (b in {
                ...
                k("touch") && (y ? a(function() {
                    ...
                    function a(b) {
                        ...
                        6 <=
                            k("ios") && (d.touches = b.touches, d.altKey = b.altKey, d.changedTouches = b.changedTouches, d.ctrlKey = b.ctrlKey, d.metaKey = b.metaKey, d.shiftKey = b.shiftKey, d.targetTouches = b.targetTouches);
                        return d
                    }
                    H = d.body();
                    ...
                    b(d.doc, "touchmove", function(e) {
                        G = (new Date).getTime();
                        var c = d.doc.elementFromPoint(e.pageX -
                            (t ? 0 : d.global.pageXOffset), e.pageY - (t ? 0 : d.global.pageYOffset));
                        c && (H !== c && (b.emit(H, "dojotouchout", {
                            ...
                            relatedTarget: H,
                            bubbles: !0
                        }), H = c), b.emit(c, "dojotouchmove", a(e)) || e.preventDefault())
                    });
        ...
        "mojo/signup-forms/SignupFormFrame": function() {
            define("dojo/_base/declare dijit/_WidgetBase ./SignupForm dojo/query dojo/_base/lang dojo/window dojo/on dojo/dom dojo/dom-geometry dojo/dom-construct dojo/dom-style dojo/dom-attr dojo/dom-class dojo/promise/all dojo/Deferred dojo/html dojo/sniff mojo/widgets/_CustomStyleRulesMixin".split(" "),
                function(m, l, g, h, c, b, k, f, a, d, e, z, n, t, y, r, w, x) {
                    return m([l, x], {
                        version: "1.0",
                        template: 1,
                        iframe: null,
                        ...
                        postCreate: function() {
                            ...
                            t([this.loadCommonCss(), this.loadLayoutCss(), this.loadCustomCss()]).then(c.hitch(this,
                                "updateDocHeight"));
                            ...
                            "fixed" === this.config.modalVariation && (r.set(this.signupForm.descriptionContainer, this._cleanText(this.config.description)), this._showPlaceholderText())
                        },
                        startup: function() {
                            this.inherited(arguments);
                        ...
                        updateDocHeight: function() {
                            try {
                                e.set(this.iframe, "height", this.docHeight() + "px"), e.set(h(".mc-layout__modalContent")[0], "max-height", this.docHeight() + "px"), "fixed" === this.config.modalVariation && e.set(h(".mc-layout__modalContent")[0], "max-height", this.docHeight() + 1 + "px")
                            } catch (a) {}
                        },
                        ...
                        loadCommonCss: function() {
                            ...
                            b.rel = "stylesheet";
                            b.type = "text/css";
                            b.href = "dev" === this.env ? "/css/signup-forms/popup/common.css" :
                                "//downloads.mailchimp.com/css/signup-forms/popup/" + this.version + "/common.css";
                            b.media = "all";
                            k(b, "load", function() {
                                a.resolve()
                            });
                        ...
                        loadLayoutCss: function() {
                            ...
                            "dev" === this.env ? (this.layoutCssNode.href = "/css/signup-forms/popup/layout-" + this.template +
                                        ...
                                        case "button":
                                            for (var c in this.styles[e]) switch (c) {
                                                ...
                                                case "text_color":
                                                    ...
                                                    break;
                                                case "alignment":
                                                    "right" == this.styles[e][c] ? this.addCSSRule(b, ".button", "float:right;") : "center" == this.styles[e][c] ? (this.addCSSRule(b, ".button", "float:none;margin-left:auto;margin-right:auto;"), 9 >= w("ie") ? (this.addCSSRule(b, ".button", "display:table-cell;"), this.addCSSRule(b, ".content__button", "margin-left:auto;margin-right:auto;display:table;")) :
                                                        this.addCSSRule(b, ".button", "display:table;")) : this.addCSSRule(b, ".button", "float:left;");
                                                    break;
                                                case "style":
                                            ...
                                            break;
                                        case "labels":
                                            for (c in this.styles[e]) switch (c) {
                                                case "color":
        ...
        "mojo/signup-forms/SignupForm": function() {
            define("dojo/_base/declare dijit/_WidgetBase dijit/_TemplatedMixin dijit/_FocusMixin dojo/_base/array dojo/query dojo/io-query dojo/on dojo/_base/lang dojo/request/script dojo/dom-form dojo/dom-geometry dojo/dom-construct dojo/dom-style dojo/dom-attr dojo/html dojo/Evented dojo/text!./templates/form.html dojo/text!./templates/gdprBlock.html dojo/text!./inputs/templates/Text.html dojo/text!./inputs/templates/Address.html dojo/text!./inputs/templates/Email.html dojo/text!./inputs/templates/Birthday.html dojo/text!./inputs/templates/Date.html dojo/text!./inputs/templates/Phone.html dojo/text!./inputs/templates/Number.html dojo/text!./inputs/templates/Url.html dojo/text!./inputs/templates/RadioCheckbox.html dojo/text!./inputs/templates/GdprCheckbox.html dojo/text!./inputs/templates/Select.html".split(" "),
                function(m, l, g, h, c, b, k, f, a, d, e, z, n, t, y, r, w, x, v, q, u, A, p, J, L, M, G, H, O, P) {
                    var T = m([], {
                        isEmpty: function() {
                            var b;
                    ...
                    var S = m([h], {
                        ...
                        I = m([h], {
                            ...
                            postCreate: function() {
                                c.forEach(this.choices, a.hitch(this,
                                    function(a, b) {
                        ...
                        R = m([h], {
                            ...
                            postCreate: function() {
                                ...
                                0 < b.length ? y.set(b[0], "selected", "selected") : n.place('\x3coption value\x3d"" selected\x3d"selected"\x3e\x3c/option\x3e',
                                    this.choicesContainer, "first");
                                this.inherited(arguments)
                            }
                        });
                    return m("SignupForm", [l, g, w], {
                        ...
                        postCreate: function() {
                            this.hasGdprEnabled && (this.gdprContainer = new Q({
                                ...
                                1 !== this.template && 2 !== this.template || this.gdprContainer.placeAt(this.formFieldsContainer, "after"));
                            this.addFields();
                            this.addHoneypot();
                            ...
                            f(this.formNode, "submit", function(c) {
                                ...
                                c.preventDefault();
                                a._validateForm();
                                a.formIsValid ? (a.config.captcha ? (c = a._getCaptchaForm(), window.open(c), t.set(b(".mc-closeModal", this.modalClose)[0], "display", "none"), t.set(b(".mc-modal", this.mcModal)[0],
                                    "display", "none"), t.set(b(".mc-modal-bg", this.modalOverlay)[0], "display", "none")) : d.get(a._getJsonPostUrl(), {
                                    jsonp: "c",
                        ...
                        addHoneypot: function() {
                            var a = n.toDom('\x3cdiv style\x3d"position:absolute;left:-5000px;"\x3e\x3cinput type\x3d"text" name\x3d"' +
                        ...
                        _handleSuccessResponse: function(d) {
                            ...
                            t.set(this.formContentContainer, "display",
                                "none");
                        ...
                        _handleErrorResponse: function(a) {
                            ...
                            a.msg && ((d = b(".flash-errors", this.formResponseMessages)[0]) ||
                                (d = n.place('\x3cdiv class\x3d"flash-errors"\x3e\x3c/div\x3e', this.formResponseMessages)), r.set(d, a.msg), "absolute" === t.getComputedStyle(this.formImageContainer).position && t.set(this.formImageContainer, {
                            ...
                            a.errors && (this.hasGdprEnabled && "gdpr_error" === a.type ? n.place("\x3cdiv class\x3d'invalid-error'\x3e" + a.errors.msg + "\x3c/div\x3e", this.gdprContainer.gdprFormResponseMessages, "only") : c.forEach(this.fieldNodes, function(b) {
                                a.errors.hasOwnProperty(b.merge_id) ? b.setFieldAsInvalid(a.errors[b.merge_id]) :
                                    b.setFieldAsValid()
                            }))
                        },
        ...
        "dijit/focus": function() {
            define("dojo/aspect dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/Evented dojo/_base/lang dojo/on dojo/domReady dojo/sniff dojo/Stateful dojo/_base/window dojo/window ./a11y ./registry ./main".split(" "),
                function(m, l, g, h, c, b, k, f, a, d, e, z, n, t, y, r, w) {
                    var x, v, q = new(l([z, k], {
                        curNode: null,
                        activeStack: [],
                        constructor: function() {
                        ...
                        registerWin: function(b, d) {
                            ...
                            if (f) {
                                var g = e("pointer-events") ? "pointerdown" : e("MSPointer") ?
                        ...
                        _onBlurNode: function(a) {
                            ...
                            }), 0), this._clearActiveWidgetsTimer && clearTimeout(this._clearActiveWidgetsTimer), a < v + 100 || (this._clearActiveWidgetsTimer = setTimeout(f.hitch(this, function() {
                        ...
                        _setStack: function(a, b) {
                            ...
                            if (a[c] != d[e]) {
                                ...
                                for (f = e; 0 <= f && d[f] != a[f]; f--)
                                    if (e = r.byId(d[f])) e._hasBeenBlurred = !0, e.set("focused", !1), e._focusManager == this && e._onBlur(b),
                                        this.emit("widget-blur", e, b);
                                for (f++; f <= c; f++)
                                    if (e = r.byId(a[f])) e.set("focused", !0), e._focusManager == this && e._onFocus(b), this.emit("widget-focus", e, b)
                            }
                        },
                        focus: function(a) {
                            if (a) try {
                    ...
                    for (var u in q) /^_/.test(u) || (w.focus[u] = "function" == typeof q[u] ? f.hitch(q, u) : q[u]);
                        ...
                        scrollIntoView: function(a, d) {
                            try {
                                ...
                                var e = a.ownerDocument || g.doc,
                                    ...
                                    m = l("webkit");
                                if (a != f && a != n)
                                    if (!(l("mozilla") || k || m || l("opera") || l("trident")) && "scrollIntoView" in a) a.scrollIntoView(!1);
                                    else {
                                        var r = "BackCompat" == e.compatMode,
                                            w = Math.min(f.clientWidth ||
                                            ...
                                            u = this,
                                            A = function(a, b, d) {
                                                "BODY" == a.tagName || "HTML" == a.tagName ? u.get(a.ownerDocument).scrollBy(b, d) : (b && (a.scrollLeft += b), d && (a.scrollTop += d))
                                            };
                                        if (!m(a))
                                            for (; q;) {
                                                q == f && (q = e);
                                                ...
                                                if (q == e) {
                                                    ...
                                                    if (0 > p.x || !k || 9 <= k || l("trident")) p.x = 0;
                                                    if (0 > p.y || !k || 9 <= k || l("trident")) p.y = 0
                                                } else {
                                                    ...
                                                    var G = q.clientWidth,
                                                        H = p.w - G;
                                                    0 < G && 0 < H && (L && l("rtl-adjust-position-for-verticalScrollBar") && (p.x += H), p.w = G);
                                                    G = q.clientHeight;
                                                    H = p.h - G;
                                                    0 < G && 0 < H && (p.h = G)
                                                }
                                                J && (0 > p.y && (p.h += p.y, p.y = 0), 0 > p.x && (p.w += p.x, p.x = 0), p.y + p.h > x && (p.h = x - p.y), p.x + p.w > w && (p.w = w - p.x));
                                                var O = v.x - p.x,
                                                    P = v.y - p.y,
                                                    T = O + v.w -
                                                    p.w,
                                                    S = P + v.h - p.h,
                                                    F, B;
                                                0 < T * O && (q.scrollLeft || q == e || q.scrollWidth > q.offsetHeight) && (F = Math[0 > O ? "max" : "min"](O, T), L && (8 == k && !r || 9 <= k || l("trident")) && (F = -F), B = q.scrollLeft, A(q, F, 0), F = q.scrollLeft - B, v.x -= F);
                                                0 < S * P && (q.scrollTop || q == e || q.scrollHeight > q.offsetHeight) && (F = Math.ceil(Math[0 > P ? "max" : "min"](P, S)), B = q.scrollTop, A(q, 0, F), F = q.scrollTop - B, v.y -= F);
            ...
            define("dojo/_base/array dojo/dom dojo/dom-attr dojo/dom-style dojo/_base/lang dojo/sniff ./main".split(" "),
                function(m, l, g, h, c, b, k) {
                    var f = {
                        ...
                        getFirstInTabbingOrder: function(a,
                            b) {
        ...
        "dojo/request/script": function() {
            define("module ./watch ./util ../_base/kernel ../_base/array ../_base/lang ../on ../dom ../dom-construct ../has ../_base/window".split(" "), function(m, l, g, h, c, b, k, f, a, d, e) {
                ...
                function w(a, d, e) {
                    var c = g.parseArgs(a, g.deepCopy({},
                        d));
                    a = c.url;
                    d = c.options;
                    ...
                    d.jsonp && ((new RegExp("[?\x26]" + d.jsonp + "\x3d")).test(a) || (a += (~a.indexOf("?") ? "\x26" : "?") + d.jsonp + "\x3d" + (d.frameDoc ? "parent." : "") + x + "_callbacks." + f.id), f.canDelete = !0, A[f.id] = function(a) {
                        c.data = a;
                        f.handleResponse(c)
                    });
                    ...
                    if (!d.canAttach || d.canAttach(f)) {
                        ...
                        if (!d.jsonp && !d.checkString) var p = k(h, q, function(a) {
                            if ("load" ===
                                a.type || u.test(h.readyState)) p.remove(), f.scriptLoaded = a
                        })
                    }
                    l(f);
                ...
                var f = 0,
                    a = {
                        ...
                        _setNodeContent: function(a, e) {
                            b.empty(a);
                            if (e)
                                if ("string" == typeof e && (e = b.toDom(e, a.ownerDocument)), !e.nodeType && l.isArrayLike(e))
                                    for (var c = e.length, f = 0; f < e.length; f = c == e.length ? f + 1 : 0) b.place(e[f], a, "last");
                                else b.place(e, a, "last");
                            return a
                        },
                        _ContentSetter: h("dojo.html._ContentSetter", null, {
                            ...
                            empty: function() {
                                this.parseDeferred && (this.parseDeferred.isResolved() ||
                                    this.parseDeferred.cancel(), delete this.parseDeferred);
            ...
            define("require ./_base/kernel ./_base/lang ./_base/array ./_base/config ./dom ./_base/window ./_base/url ./aspect ./promise/all ./date/stamp ./Deferred ./has ./query ./on ./ready".split(" "), function(m, l, g, h, c, b, k, f, a, d, e, z, n, t, y, r) {
                ...
                function x(a) {
                    ...
                    if (!b || b._extendCnt < q) {
                        var b = a._nameCaseMap = {},
                            e;
                        for (e in d) "_" !== e.charAt(0) && (b[e.toLowerCase()] = e);
                        b._extendCnt = q
                    }
                    return b
                }
                ...
                var u = {},
                    A = {
                        ...
                        construct: function(b, d, c, k, m, q) {
                            function z(b) {
                                A && g.setObject(A, b);
                                for (C = 0; C < K.length; C++) a[K[C].advice || "after"](b, K[C].method, g.hitch(b,
                                    K[C].func), !0);
                                for (C = 0; C < Q.length; C++) Q[C].call(b);
                                for (C = 0; C < R.length; C++) b.watch(R[C].prop, R[C].func);
                                for (C = 0; C < U.length; C++) y(b, U[C].event, U[C].func);
                                return b
                            }
                            var u = b && b.prototype;
                            k = k || {};
                            ...
                            n("dom-attributes-explicit") ? v = d.attributes : n("dom-attributes-specified-flag") ? v = h.filter(d.attributes, function(a) {
                                return a.specified
                            }) : (q = (/^input$|^img$/i.test(d.nodeName) ? d : d.cloneNode(!1)).outerHTML.replace(/=[^\s"']+|="[^"]*"|='[^']*'/g, "").replace(/^\s*<[a-zA-Z0-9]*\s*/,
                                "").replace(/\s*>.*$/, ""), v = h.map(q.split(/\s+/), function(a) {
                                var b = a.toLowerCase();
                                return {
                                    name: a,
                            ...
                            q = "data-" + F + "-";
                            var B = {};
                            "dojo" !== F && (B[q + "props"] = "data-dojo-props", B[q + "type"] = "data-dojo-type", B[q + "mixins"] = "data-dojo-mixins", B[F + "type"] = "dojoType", B[q + "id"] = "data-dojo-id");
                            for (var C = 0, D, F = [], A, N; D = v[C++];) {
                                ...
                                switch (B[I] || I) {
                                    ...
                                    case "style":
                                        ...
                                        break;
                                    default:
                                        if (E in u || (E = x(b)[I] || E), E in u) switch (typeof u[E]) {
                                            case "string":
                                                r[E] = D;
                                                break;
                                            case "number":
                                            ...
                                            case "function":
                                                ...
                                                break;
                                            default:
                                                I = u[E], r[E] = I && "length" in I ? D ? D.split(/\s*,\s*/) : [] : I instanceof Date ? "" == D ? new Date("") : "now" == D ? new Date : e.fromISOString(D) : I instanceof f ? l.baseUrl + D : w(D)
                                        } else r[E] = D
                                }
                            }
                            for (v = 0; v < F.length; v++) B = F[v].toLowerCase(), d.removeAttribute(B), d[B] = null;
                            if (N) try {
                                N = w.call(k.propsThis, "{" + N + "}"), g.mixin(r, N)
                            } catch (W) {
                                throw Error(W.toString() + " in data-dojo-props\x3d'" +
                                    N + "'");
                            }
                            g.mixin(r, c);
                            ...
                            var K = [],
                                ...
                                U = [];
                            if (m)
                                for (C = 0; C < m.length; C++) B = m[C], d.removeChild(B), c = B.getAttribute(q + "event") || B.getAttribute("event"), k = B.getAttribute(q + "prop"), N = B.getAttribute(q + "method"), F = B.getAttribute(q + "advice"), v = B.getAttribute("type"), B = this._functionFromScript(B, q), c ? "dojo/connect" == v ? K.push({
                                    method: c,
                                    func: B
                                }) : "dojo/on" == v ? U.push({
                                    event: c,
                        ...
                        scan: function(a, b) {
                            function d(a) {
                                if (!a.inherited) {
                                    ...
                                    var b = a.node,
                                        ...
                                        c;
                                    for (c in b) b[c] && (a.inherited[c] = b[c])
                                }
                                return a.inherited
                            }
                            var e = [],
                            ...
                            for (var t = {
                                ...
                                if (u)
                                    ...
                                    else if (A && "script" == u.nodeName.toLowerCase())(E = u.getAttribute("type")) && /^dojo\/\w/i.test(E) && A.push(u), u = u.nextSibling;
                            else if (x) u = u.nextSibling;
                            else {
                            ...
                            var K = new z;
                            c.length ? (n("dojo-debug-messages"), (b.contextRequire || m)(c, function() {
                        ...
                        _require: function(a, b) {
                            var d = w("{" + a.innerHTML +
                                ...
                                k;
                            for (k in d) e.push(k), c.push(d[k]);
                            h(c, function() {
                                for (var a = 0; a < e.length; a++) g.setObject(e[a], arguments[a]);
                                f.resolve(arguments)
                            });
                            return f.promise
                        },
                    ...
                    h = function() {
                        for (var c = arguments, b = [c[0]], k = 1; k < c.length; k++)
                            if (c[k]) {
                                var f = new h(c[k] + ""),
                                    b = new h(b[0] + "");
                                if ("" == f.path && !f.scheme && !f.authority && !f.query) null != f.fragment && (b.fragment = f.fragment), f = b;
                                else if (!f.scheme && (f.scheme = b.scheme, !f.authority && (f.authority = b.authority, "/" != f.path.charAt(0)))) {
                                    for (var b = (b.path.substring(0, b.path.lastIndexOf("/") + 1) + f.path).split("/"), a = 0; a < b.length; a++) "." == b[a] ? a == b.length - 1 ? b[a] = "" : (b.splice(a, 1), a--) : 0 < a && (1 != a || "" != b[0]) && ".." == b[a] && ".." != b[a - 1] &&
                                        (a == b.length - 1 ? (b.splice(a, 1), b[a - 1] = "") : (b.splice(a - 1, 2), a -= 2));
                                    f.path = b.join("/")
                                }
                                b = [];
                        ...
                        null != this.authority && (c = this.authority.match(g), this.user = c[3] || null, this.password =
        ...
        "dojo/promise/all": function() {
            define(["../_base/array", "../Deferred", "../when"], function(m, l, g) {
                ...
                return function(c) {
                    ...
                    if (b) {
                        k = [];
                        for (var d in b) Object.hasOwnProperty.call(b, d) && (a.push(d), k.push(b[d]));
                        f = {}
                    } else k && (f = []);
                    if (!k || !k.length) return (new l).resolve(f);
                    var e = new l;
                    ...
                    h(k, function(d, c) {
                        b || a.push(c);
                        g(d, function(b) {
                            e.isFulfilled() || (f[a[c]] = b, 0 === --m && e.resolve(f))
                        }, e.reject);
            ...
            define(["../_base/lang", "../_base/array"], function(m, l) {
                ...
                g.fromISOString = function(h, c) {
                    ...
                    if (b) {
                        ...
                        var f = 0,
                            a = b[7] && b[7].charAt(0);
                        "Z" != a && (f = 60 * (b[8] || 0) + (Number(b[9]) || 0), "-" != a && (f *= -1));
                ...
                g.toISOString =
                    function(g, c) {
                        ...
                        var k = [],
                            f = c.zulu ? "getUTC" : "get",
                            a = "";
                        "time" != c.selector && (a = g[f + "FullYear"](), a = ["0000".substr((a + "").length) + a, b(g[f + "Month"]() + 1), b(g[f + "Date"]())].join("-"));
                        k.push(a);
                        if ("date" != c.selector) {
                            ...
                            if (c.zulu) a += "Z";
                            else if ("time" != c.selector) var f = g.getTimezoneOffset(),
                                d = Math.abs(f),
                                a = a + ((0 < f ? "-" : "+") +
                                    b(Math.floor(d / 60)) + ":" + b(d % 60));
                            k.push(a)
                        }
                        return k.join("T")
                    };
            ...
            define(["dojo/_base/declare", "dojo/sniff"], function(m, l) {
                return m([], {
                    createStyleNode: function(g, h) {
                        var c;
                        if (h && (c = g.getElementById(h))) return c;
                ...
                function(m, l, g, h, c, b, k, f, a, d, e, z, n, t, y, r, w, x) {
                    ...
                    return m([l, x], {
                        ...
                        postCreate: function() {
                            ...
                            t([this.loadCommonCss(), this.loadBannerCss(), this.loadCustomCss()]).then(c.hitch(this,
                                function() {
                                        ...
                                        case "button":
                                            for (var c in this.styles[e]) switch (c) {
                                                ...
                                                case "text_color":
                                                    ...
                                                    break;
                                                case "alignment":
                                                    "right" === this.styles[e][c] ? this.addCSSRule(b, ".bannerContent__subscribeButton", "float:right;") : "center" === this.styles[e][c] ? (this.addCSSRule(b, ".bannerContent__subscribeButton", "float:none;margin-left:auto;margin-right:auto;"), 9 >= r("ie") ?
                                                        (this.addCSSRule(b, ".bannerContent__subscribeButton", "display:table-cell;"), this.addCSSRule(b, ".bannerContent__buttonContainer", "margin-left:auto;margin-right:auto;display:table;")) : this.addCSSRule(b, ".bannerContent__subscribeButton", "display:table;")) : this.addCSSRule(b, ".bannerContent__subscribeButton", "float:left;");
                                                    break;
                                                case "style":
        ...
        "dojo/NodeList-manipulate": function() {
            define("./query ./_base/lang ./_base/array ./dom-construct ./dom-attr ./NodeList-dom".split(" "),
                function(m, l, g, h, c) {
                    function b(a) {
                    ...
                    function k(a, b) {
                        "string" == typeof a ? (a = h.toDom(a, b && b.ownerDocument), 11 == a.nodeType && (a = a.childNodes[0])) : 1 == a.nodeType && a.parentNode && (a = a.cloneNode(!1));
                        return a
                    }
                    var f = m.NodeList;
                    l.extend(f, {
                        _placeMultiple: function(a, b) {
                            for (var e = "string" == typeof a || a.nodeType ? m(a) : a, c = [], f = 0; f < e.length; f++)
                                for (var g = e[f], k = this.length, l = k - 1, w; w = this[l]; l--) 0 < f && (w = this._cloneNode(w), c.unshift(w)), l == k -
                                    1 ? h.place(w, g, b) : g.parentNode.insertBefore(w, g), g = w;
                        ...
                        text: function(a) {
                            if (arguments.length) {
                                for (var b = 0, e; e = this[b]; b++) 1 == e.nodeType && c.set(e, "textContent", a);
                                return this
                            }
                            for (var f = "", b = 0; e = this[b]; b++) f += c.get(e, "textContent");
                            return f
                        },
                        val: function(a) {
                            if (arguments.length) {
                                for (var b = l.isArray(a), e = 0, c; c = this[e]; e++) {
                                    var f =
                                        ...
                                        k = b ? a[e] : a;
                                    if ("SELECT" == f)
                                        for (f = c.options, h = 0; h < f.length; h++) {
                                            var m = f[h];
                                            m.selected = c.multiple ? -1 != g.indexOf(a, m.value) : m.value == k
                                        } else "checkbox" == h || "radio" == h ? c.checked = c.value == k : c.value = k
                                }
                                return this
                            }
                            if ((c = this[0]) && 1 == c.nodeType) {
                                ...
                                if ("SELECT" == c.nodeName.toUpperCase() && c.multiple) {
                                    a = [];
                                    f = c.options;
                                    for (h = 0; h < f.length; h++) m = f[h], m.selected && a.push(m.value);
                                    a.length || (a = null)
                                }
                                return a
                            }
                        ...
                        wrap: function(a) {
                            if (this[0]) {
                                ...
                                for (var d = 0, c; c = this[d]; d++) {
                                    ...
                                    c.parentNode && c.parentNode.replaceChild(f,
                                        c);
                                    b(f).appendChild(c)
                                }
                            }
                        ...
                        replaceAll: function(a) {
                            a = m(a);
                            for (var b = this._normalize(this, this[0]), c = 0, f; f = a[c]; c++) this._place(b, f, "before", 0 < c), f.parentNode.removeChild(f);
                            return this
                        },
                        clone: function() {
